...
async function captureScreenshots() {
  ...
  const takePic = async (url, filename, viewport = { width: 1440, height: 900 }) => {
  ...
  await takePic('/customer/dashboard', 'part8a_12_mobile_navigation.png', { width: 390, height: 844 });
  ...
  await browser.close();
  console.log('=== All 16 Part 8A Visual QA Screenshots Captured Successfully! ===');
}
