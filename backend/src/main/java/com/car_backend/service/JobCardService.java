...
public interface JobCardService {
	...
	List<MechanicWorkloadDto> getManagerTeamWorkload(Long managerId);

	List<JobCardResponseDto> searchHistory(String keyword, Long managerId);

	JobCardResponseDto submitRating(Long jobCardId, Integer rating, String feedback);
}
